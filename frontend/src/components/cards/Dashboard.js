            ...
            <Fragment>
                <div className="flex justify-center items-center mt-6">
                    <div className="sm:flex justify-center items-center text-center gap-14">
                        <div className="sm:w-1/2 md:w-1/2 lg:w-1/4 h-56 w-56 px-4 py-4 bg-white mt-6 hover:bg-indigo-900
             transition ease-in duration-200  shadow-lg rounded-lg dark:bg-gray-800">
                        ...
                        <div className="min-w-4 sm:w-1/2 md:w-1/2 lg:w-1/4 h-56 w-56 hover:bg-indigo-900
